...
const newAdmin = ({ shareList, shareTotal, sharePage, sharePageSize, 
  getAllShare, postCreateShare, putModifyShare, 
  deleteShare, putOnshelvesShare, putOffshelvesShare, saveAdverPagination
}) => {
  ...
  return (
    <Card>
      <div style={{ margin: 10 }}>
        <Button type="primary" onClick={handleCreateShare}>创建分享活动</Button>
      </div>
      <Table
        scroll={{ x: true }}
