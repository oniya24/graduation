...
const newAdmin = ({ flashSegList, flashSegTotal, flashSegPage, flashSegPageSize, 
  getAllFlashsaleSegments, postCreateFlashsaleSegments, deleteFlashsaleSegmentsById, saveAdverPagination
}) => {
  ...
  return (
    <Card>
      <div style={{ margin: 10 }}>
        <Button type="primary" onClick={handleCreateAdverSeg}>创建秒杀时间段</Button>
      </div>
      <Table
        scroll={{ x: true }}
