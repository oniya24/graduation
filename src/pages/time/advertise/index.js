...
import { Card, Table, Button, Tooltip, Space, Form, DatePicker, Modal } from 'antd';
import {
  mapStateToProps,
  mapDispatchToProps,
} from '@/models/Time';
import pagination from '@/utils/pagination';
const newAdmin = ({ adverSegList, adverSegTotal, adverSegPage, adverSegPageSize, 
  getAllAdvertiseSegments, postCreateAdvertiseSegments, deleteAdvertiseSegmentsById, saveAdverPagination
}) => {
  ...
  return (
    <Card>
      <div style={{ margin: 10 }}>
        <Button type="primary" onClick={handleCreateAdverSeg}>创建广告时间段</Button>
      </div>
      <Table
        scroll={{ x: true }}
