...
const userManage_comment = ({ 
  ...
  getAllComments, putComfirmComment, savePagination
 }) => {
    ...
    return [
      ...
      },
      {
        ...
        render: (text, record) => {
          return(
            <Space>
              <Button type="danger" onClick={() => handleConfirmComment(record,true)}>审核通过</Button>
              <Button type="danger" onClick={() => handleConfirmComment(record,false)}>审核不通过</Button>
            </Space>
          )
        }
      }
