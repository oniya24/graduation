...
const goods_category = ({ categoryList, categoryTotal, categoryPage, categoryPageSize, 
  getAllCategory, postAddCategory, putModifyCategory, deleteCategory, saveCategoryPagination
}) => {
    ...
    return [
      ...
      },
      {
        ...
        render: (text, record) => {
          ...
          return (
            <Space>
              <Button type="default" onClick={() => handleModifyCategory(record)}>
                修改活动信息
              </Button>
  ...
  return (
    <Card>
      <div style={{ margin: 10 }}>
        <Button type="primary" onClick={handleCreateCategory}>新增分类</Button>
      </div>
      <Table
        scroll={{ x: true }}
