...
const goods_brand = ({ brandList, brandTotal, brandPage, brandPageSize, 
  getAllBrand, postAddBrand, putModifyBrand, deleteBrand, saveBrandPagination
}) => {
  ...
  return (
    <Card>
      <div style={{ margin: 10 }}>
        <Button type="primary" onClick={handleCreateBrand}>新增品牌</Button>
      </div>
      <Table
        scroll={{ x: true }}
