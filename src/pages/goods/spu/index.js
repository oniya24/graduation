...
const goods_spu = ({ spuList, spuTotal, spuPage, spuPageSize, 
  getAllSpu, postAddSpu, putModifySpu, deleteSpu, saveSpuPagination
}) => {
        ...
        render: (text, record) => {
          ...
          return (
            <Space>
              ...
              <Button type="default" onClick={() => history.push(`/goods/spu/${id}`)}>查看详情</Button>
  ...
  return (
    <Card>
      <div style={{ margin: 10 }}>
        <Button type="primary" onClick={handleCreateSpu}>新增商品</Button>
      </div>
      <Table
        scroll={{ x: true }}
      ...
      >
        <Form form={form}>
          ...
          <Form.Item label="描述" name="decription" required
            rules={
              [
          ...
          <Form.Item label="规格" name="specs" required
            rules={
              [
