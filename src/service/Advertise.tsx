...
// 管理员设置默认广告
export const putDefaultAdvertiseReq = ({did,id}:{did:number, id:number}) => {
...
export const putModifyAdvertiseReq = ({did,id,...data}:{did:number,id:number,data:advertiseData}) => {
...
// 管理员上传广告图片
export const postUploadImgReq = ({did,id,img}:{did:number,id:number,img:any}) => {
...
// 管理员上架广告
export const putOnshelvesAdvertiseReq = ({did,id}:{did:number,id:number}) => {
...
// 管理员下架广告
export const putOffshelvesAdvertiseReq = ({did,id}:{did:number,id:number}) => {
...
export const putAuditAdvertiseReq = ({did,id, ...data}:{did:number,id:number, data:advertiseAudit}) => {
...
// 管理员查看某一个广告时间段的广告
export const getAllSegmentsAdvertiseReq = ({did,id,...params}:{did:number,id:number,params:any}) => {
...
// 管理员在广告时段下新建广告
export const postCreateSegmentsAdvertiseReq = ({did,id,...params}:{did:number,id:number,params:advertiseData}) => {
  return request(`/shops/${did}/timesegments/${id}/advertisement`,{
    method: 'post',
    params: params
  })
