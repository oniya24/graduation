...
export const putModifyShopReq = ({id,...data}:{id:number,data:shopData}) => {
...
export const deleteShopReq = ({id,...data}:{id:number,data:shopData}) => {
  return request(`/shops/${id}`,{
    method: 'delete',
    data: data
  })
...
// 平台管理员审核店铺信息
export const putAuditShopReq = ({shopId ,id, ...data}:{shopId:number,id:number,data:any}) =>{
