...
// 管理员新增SKU预售活动
export const postCreatePresaleReq = ({shopId,id,...data}:{shopId:number,id:number, data:SkuData}) => {
...
// 管理员修改SKU预售活动
export const putModifyPresaleReq = ({shopId,id,...data}:{shopId:number,id:number, data:SkuData}) => {
...
// 管理员逻辑删除SKU预售活动
export const deletePresaleReq = ({shopId,id,...data}:{shopId:number,id:number, data:SkuData}) => {
  return request(`/shops/${shopId}/presales/${id}`,{
    method: 'delete',
  })
}
