...
import { Card, Divider, Descriptions, Table, Space, Button, Modal, DatePicker, Form, Select } from 'antd';
import { mapStateToProps, mapDispatchToProps } from '@/models/personal/SelfProxy';
  ...
  return (
    <Card>
      ...
      <Table 
        ...
        columns={columns} 
        dataSource={selfProxies}></Table>
      <Modal 
        destroyOnClose={true}
        visible={selfModalVisible} 
        cancelText={"取消"} onCancel={() => setSelfModalVisible(false)}  
        okText={"修改"} onOk={() => createSelfProxy()}
      >
        <Form
          form={form1}
          preserve={false}
