...
import { mapStateToProps, mapDispatchToProps } from '@/models/personal/SelfRole';
    ...
    return [
      ...
      },
      {
        ...
        render: (text, record) => {
          return (
            <Space>
              <Button type="primary" onClick={() => openPriDrawer(record) }>查看角色权限</Button>
            </Space>
          )
        }
      }
