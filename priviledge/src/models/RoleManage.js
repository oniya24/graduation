...
export const mapStateToProps = ({ RoleManage, loading }) => {
  ...
  roleTotal, rolePage, rolePageSize, } = RoleManage
  return {
    priList,
...
export const mapDispatchToProps = (dispatch) => {
  return {
    getRoleByDid: (payload) =>  dispatch({ type: 'RoleManage/getRoleByDid', payload}),
    deleteRoleByDid: (payload) => dispatch({ type: 'RoleManage/deleteRoleByDid', payload}),
    postRoleByDid: (payload) => dispatch({ type: 'RoleManage/postRoleByDid', payload}),
    putRoleByDid: (payload) => dispatch({ type: 'RoleManage/putRoleByDid', payload}),
