...
import { getAllAdminReq, getAdminByIdReq, 
    updateAdminByIdReq, deleteAdminByIdReq,
    approveAdminByIdReq, forbidAdminByIdReq, releaseAdminByIdReq,
    getAllRoleByDidReq, cancelRoleFromAdminReq, addRoleFromAdminReq, getRoleByDidReq 
  } from '@/service/AdminManage';
import { message } from 'antd';


export const mapStateToProps = ({ AdminManage, loading }) => {
  const { adminList, adminInfo, adminRoleList, allRoleList, 
    adminTotal, adminPage, adminPageSize, } = AdminManage;
  return {
    adminList, adminInfo,
...
export const mapDispatchToProps = (dispatch) => {
  return {
    getAllAdmin: (payload) =>  dispatch({ type: 'AdminManage/getAllAdmin', payload}),
    getAdminById: (payload) => dispatch({ type: 'AdminManage/getAdminById', payload}),
    updateAdminById: (payload) => dispatch({ type: 'AdminManage/updateAdminById', payload}),
    deleteAdminById: (payload) => dispatch({ type: 'AdminManage/deleteAdminById', payload}),
    forbidAdminById: (payload) => dispatch({ type: 'AdminManage/forbidAdminById', payload}),
    releaseAdminById: (payload) => dispatch({ type: 'AdminManage/releaseAdminById', payload}),
    approveAdminById: (payload) => dispatch({ type: 'AdminManage/approveAdminById', payload}),
    getAllRoleByDid: (payload) => dispatch({type: 'AdminManage/getAllRoleByDid', payload}),  
    getRoleByDid: (payload) => dispatch({type: 'AdminManage/getRoleByDid', payload}), 
    cancelRoleFromAdmin: (payload) => dispatch({type: 'AdminManage/cancelRoleFromAdmin', payload}), 
    addRoleFromAdmin: (payload) => dispatch({type: 'AdminManage/addRoleFromAdmin', payload}),
    savePagination: (payload) => dispatch({type: 'AdminManage/savePagination', payload})
  }
}
