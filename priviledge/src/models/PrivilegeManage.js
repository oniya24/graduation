...
import { getAllPrivilege, updatePrivilegeById } from '@/service/PrivilegeManage';
...
export const mapDispatchToProps = (dispatch) => {
  return {
    getPriList: (payload) => dispatch({type: 'PrivilegeManage/getPriList', payload}),
    updatePriInfo: (payload) =>  dispatch({ type: 'PrivilegeManage/updatePriInfo', payload}),
    savePagination: (payload) => dispatch({type: 'PrivilegeManage/savePagination', payload})
  }
}
