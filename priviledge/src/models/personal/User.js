...
import { updateUserReq, getUserReq, sendAuthCodeReq, updatePasswordReq } from '@/service/personal/User';
...
export const mapDispatchToProps = (dispatch) => {
  return {
    ...
    updatePassword: (payload) => dispatch({ type: 'User/updatePassword', payload}),
  }
}
