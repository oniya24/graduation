...
export const mapStateToProps = ({ ProxyManage, loading }) => {
  ...
  return {
    proxyList,
    adminList, 
    proxyTotal, proxyPage, proxyPageSize,
...
export const mapDispatchToProps = (dispatch) => {
  return {
    getAllProxy: (payload) =>  dispatch({ type: 'ProxyManage/getAllProxy', payload}),
    deleteProxyById: (payload) => dispatch({ type: 'ProxyManage/deleteProxyById', payload}),
    ...
    proxyList: [
      {
          ...
          "signature": "bb1378ee78a41e6a37abd37aa2247af1f2962fc229ca84cf53981fb6b2fe37bc",
          "valid": 1,
          "departId": 0
      },
      {
          ...
          "signature": "006d2a321a041446b8c19f33bda62c49bdefe6bd12705d1be50c45dedb4842bb",
          "valid": 1,
          "departId": 0
      }]    
  },
